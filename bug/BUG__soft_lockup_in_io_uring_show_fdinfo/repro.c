...
void execute_one(void)
{
  ...
  //      int64 = 0x3 (8 bytes)
  //    }
  //    maxnode: intptr = 0x9 (8 bytes)
  //    flags: mbind_flags = 0x0 (8 bytes)
  //  ]
  *(uint64_t*)0x200000000040 = 3;
  syscall(__NR_mbind, /*addr=*/0x200000960000ul, /*len=*/0x2000ul,
          /*mode=MPOL_BIND*/ 2ul, /*nodemask=*/0x200000000040ul,
          /*maxnode=*/9ul, /*flags=*/0ul);
  //  syz_io_uring_setup arguments: [
  //    entries: int32 = 0x30c2 (4 bytes)
  //    params: ptr[inout, io_uring_params] {
  //      io_uring_params {
  //        sq_entries: int32 = 0x0 (4 bytes)
  //        cq_entries: int32 = 0x0 (4 bytes)
  //        flags: io_uring_setup_flags = 0x13250 (4 bytes)
  ...
  *(uint32_t*)0x200000000008 = 0x13250;
  *(uint32_t*)0x20000000000c = 0;
  *(uint32_t*)0x200000000010 = 0;
  *(uint32_t*)0x200000000018 = -1;
  memset((void*)0x20000000001c, 0, 12);
  syz_io_uring_setup(/*entries=*/0x30c2, /*params=*/0x200000000000,
                     /*ring_ptr=*/0x200000000080, /*sqes_ptr=*/0x2000000000c0);
  ...
  //      buffer: (DirOut)
  //    }
  //    count: len = 0xf1 (8 bytes)
  //  ]
  syscall(__NR_read, /*fd=*/r[0], /*buf=*/0x200000000040ul, /*count=*/0xf1ul);
}
int main(void)
{
